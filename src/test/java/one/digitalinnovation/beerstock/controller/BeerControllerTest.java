...
public class BeerControllerTest {
	...
	@Test
	void whenGETListWithBeersIsCallesThenOKStatusIsReturned() throws Exception {
	...
	@Test
	void whenDELETEIsCalledWithAnInvalidIdThenNoNotFoundStatusIsReturned () throws Exception {
